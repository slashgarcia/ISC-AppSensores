...
class OtroTest extends StatefulWidget {
  @override
  _OtroTestState createState() => _OtroTestState();
}

class _OtroTestState extends State<OtroTest> {
  Timer timer;
  var valor;
  @override
  void initState() {
    super.initState();
    timer = Timer.periodic(Duration(seconds: 1), (Timer t) => getValues());
  }
